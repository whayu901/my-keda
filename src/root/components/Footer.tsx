...
const Footer = () => {
  return (
    <footer id="contact" className="bg-primary pt-20 pb-12 mt-20">
      ...
      text-gray-800"
            ...
            <h3 className="mb-2 text-2xl font-bold text-white">Hubungi Kami</h3>
            <p className="text-white">cahyonowahyus123@gmail.com</p>
            <p className="text-white">Jl. Kemuning Kebon Jeruk</p>
            <p className="text-white">Jakarta</p>
          </div>
          <div className="mb-12 w-full px-4 md:w-1/3">
            <div className="pb-3">
              <span className="text-xl text-white font-bold">Quick Link</span>
            </div>
            <ul className="">
              <li>
                <a
                  href="#about"
                  className="mb-3 inline-block text-base text-white hover:text-red-200"
                >
                  About
                </a>
              </li>
